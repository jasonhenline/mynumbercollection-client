    ...
    const stats: StatBlock[] = [
        {
            ...
            stats: [
                ...
                },
                {
                    ...
                    calc: () => ({
                        output: [
                            [...timeBoundNumberToCountMap().keys()].length,
                        ],
                    }),
                },
                {
                ...
                },
                {
                    ...
                    calc: () => {
                        ...
                        let columnStart =
                            Math.ceil(sortedFlatPulls[0] / 100) * 100;
                        ...
                        while (
                            ...
                            for (let i = 0; i < 10; i++) {
                                if (
                                    neededForFullColumn(columnStart + i).every(
                                        (x) => sortedFlatPulls.includes(x),
                                    )
                                ) {
                                    columnsCompleted += 1;
                                }
                ...
                },
                {
                    ...
                    calc: () => {
                        ...
                        const timeSince =
                            Date.now() -
                            grantWithHighestPull.timestamp.getTime();

                        const daysSince = Math.floor(
                            timeSince / 1000 / 3600 / 24,
                        );
                ...
                },
                {
                    ...
                    calc: () => {
                        ...
                        for (const grant of getTimeBoundGrants()) {
                            ...
                            const largest =
                                numbersInGrant[numbersInGrant.length - 1];
